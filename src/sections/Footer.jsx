...
const Footer = () => {
  return (
    <footer className="bg-zinc-900 dark:bg-neutral-100 border-t border-neutral-700 py-10">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center px-4 sm:px-6">
        {/* Copyright Info */}
        <div className="text-center md:text-left mb-4 md:mb-0">
          <span className="text-gray-400 dark:text-gray-800 text-sm font-semibold">
        ...
        <div className="flex flex-col md:flex-row items-center">
          <ul className="flex space-x-8 text-gray-400 dark:text-gray-800 text-sm">
            <li>
